...
5. For Mail that needs no reply, retain its durable read receipt and optionally call `mailbox_archive`; archive is recipient-local and does not express a business outcome.
